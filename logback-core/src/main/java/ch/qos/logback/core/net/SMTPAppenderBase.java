...
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    /**
     * Set the location where a {@link Session} resource is located in JNDI. Default value is
    ...
    /**
     * If set to true, a {@link Session} resource will be retrieved from JNDI. Default is false.
     *
